...
def solution(image, current_speed, current_steering):
    ...
    base_speed = 27.0 # We can increase this value for more aggresive driving. 
    min_speed = 15.0 # If we increase base_speed, we must decrease this value so that the car can turn the curve.
